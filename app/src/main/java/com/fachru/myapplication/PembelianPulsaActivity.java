...
public class PembelianPulsaActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapterDenomPulsa = ArrayAdapter.createFromResource(this, R.array.denom_pulsa_array, android.R.layout.simple_spinner_item);
